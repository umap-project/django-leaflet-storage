...
urlpatterns = patterns('',
    ...
    url(r'^map/embed/(?P<map_id>[\d]+)/$', views.EmbedMap.as_view(), name='map_embed'),
...
urlpatterns += decorated_patterns('', map_permissions_check,
    url(r'^map/update/(?P<map_id>[\d]+)/$', views.QuickMapUpdate.as_view(), name='map_update'),
    url(r'^map/update/extent/(?P<map_id>[\d]+)/$', csrf_exempt(views.UpdateMapExtent.as_view()), name='map_update_extent'),
    url(r'^map/update/tilelayers/(?P<map_id>[\d]+)/$', csrf_exempt(views.UpdateMapTileLayers.as_view()), name='map_update_tilelayers'),
    url(r'^map/update/editors/(?P<map_id>[\d]+)/$', csrf_exempt(views.UpdateMapEditors.as_view()), name='map_update_editors'),
