...
urlpatterns += decorated_patterns('', map_permissions_check,
    ...
    url(r'^map/(?P<map_id>[\d]+)/update/tilelayers/$', csrf_exempt(views.UpdateMapTileLayers.as_view()), name='map_update_tilelayers'),
    url(r'^map/(?P<map_id>[\d]+)/update/permissions/$', csrf_exempt(views.UpdateMapPermissions.as_view()), name='map_update_permissions'),
